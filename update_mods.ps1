...
#  7 languages: en / ru / zh / es / pt / de / fr
...
$L.en = @{
    ...
    lang_menu      = '  1 - English    2 - Русский    3 - 中文'
    lang_menu2     = '  4 - Español    5 - Português  6 - Deutsch'
    lang_menu3     = '  7 - Français'
    lang_choose    = 'Choose language (1-7):'
    lang_saved     = 'Language saved: {0}'
    lang_invalid   = 'Invalid choice. Enter a number from 1 to 7.'
}
...
$L.ru = @{
    ...
    lang_menu2     = '  4 - Español    5 - Português  6 - Deutsch'
    lang_menu3     = '  7 - Français'
    lang_choose    = 'Выберите язык (1-7):'
    lang_saved     = 'Язык сохранён: {0}'
    lang_invalid   = 'Неверный выбор. Введите число от 1 до 7.'
}

$L.zh = @{
    err_not_game   = '错误：程序不在游戏文件夹中！'
    err_location   = '当前位置：{0}'
    err_move       = '请将程序移动到 PEAK\BepInEx\plugins 文件夹后重新运行。'
    enter_exit     = '按 Enter 键退出'
    selftest_fail  = '自检错误：Compare-Versions "{0}" 与 "{1}" = {2}（预期 {3}）'
    banner         = '=== PEAK 模组更新器（ThunderStore）by PonosNasral ==='
    fetching       = '正在从 ThunderStore 获取 PEAK 模组目录...'
    attempt        = '第 {0} 次尝试，共 {1} 次。请稍候.. 原因：{2}'
    catalog_fail   = '错误：尝试 {0} 次后仍无法获取 ThunderStore 目录。'
    catalog_count  = '目录中的模组数量：{0}'
    installed_cnt  = '已安装的 ThunderStore 模组：{0}'
    empty_folder   = '{0}（空文件夹 — 可能是损坏的安装）'
    broken_mani    = '{0}（manifest.json 已损坏）'
    res_header     = '--- 检查结果 ---'
    notfound_note  = '{0} {1}（ThunderStore 上不存在，已跳过）'
    deps_header    = '缺少的依赖（针对待更新的模组）：'
    dep_missing    = '  [依赖] {0} — 未安装'
    dep_hint       = '  请从 ThunderStore 安装，否则模组可能无法工作。'
    dll_header     = '直接放在 plugins 中的 .dll 文件（无法确定版本）：'
    dll_hint       = '  提示：请将模组压缩包解压为文件夹放入 plugins，而不是直接丢 .dll — 这样脚本才能正常工作'
    skipped_hdr    = '已跳过（非 ThunderStore 文件夹）：'
    summary        = '总计：已最新 — {0}，待更新 — {1}，未找到 — {2}'
    all_uptodate   = '所有模组均为最新版本，无需更新。'
    game_warn      = '警告：游戏 PEAK 正在运行，建议退出游戏！'
    thanks         = '感谢使用我的脚本！欢迎订阅 PonosNasral 频道'
    ask_update     = '是否更新这些模组？（是 - 1，否 - 2）'
    invalid_input  = '输入无效，请输入 1 或 2。'
    cancelled      = '用户已取消更新。'
    game_red       = '警告：游戏 PEAK 正在运行！'
    files_locked   = '模组文件已被锁定，更新可能出现错误。'
    ask_anyway     = '仍要继续更新吗？（是 - 1，否 - 2）'
    cancel_close   = '用户已取消更新。请关闭游戏后重新运行脚本。'
    continuing     = '按用户决定继续...'
    starting       = '开始更新 {0} 个模组...'
    target_exists  = '    目标文件夹已存在，删除残留：{0}'
    downloading    = '    正在下载（第 {0} 次）...'
    dl_failed      = '    第 {0} 次尝试（共 {1} 次）失败：{2}'
    dl_error       = '无法下载压缩包'
    size_mismatch  = '下载的文件大小不匹配（预期 {0} 字节，实际 {1} 字节）'
    not_zip        = '下载的文件不是 zip 压缩包'
    extracting     = '    正在解压...'
    no_manifest    = '压缩包中没有 manifest.json'
    backup_line    = '    备份：{0}'
    done_line      = '    完成：{0}'
    error_line     = '    错误：{0}'
    rollback       = '    已回滚。'
    ...
    errors_list    = '  错误：{0}'
    backups_at     = '  旧版本备份：{0}'
    backups_hint   = '  （如果游戏运行正常，可以删除备份）'
    lang_title     = '=== 选择语言 ==='
    lang_menu      = '  1 - English    2 - Русский    3 - 中文'
    lang_menu2     = '  4 - Español    5 - Português  6 - Deutsch'
    lang_menu3     = '  7 - Français'
    lang_choose    = '请选择语言（1-7）：'
    lang_saved     = '语言已保存：{0}'
    lang_invalid   = '选择无效，请输入 1 到 7 之间的数字。'
}
...
$L.es = @{
    ...
    lang_menu2     = '  4 - Español    5 - Português  6 - Deutsch'
    lang_menu3     = '  7 - Français'
    lang_choose    = 'Elige idioma (1-7):'
    lang_saved     = 'Idioma guardado: {0}'
    lang_invalid   = 'Elección no válida. Escribe un número del 1 al 7.'
}
...
$L.pt = @{
    ...
    lang_menu2     = '  4 - Español    5 - Português  6 - Deutsch'
    lang_menu3     = '  7 - Français'
    lang_choose    = 'Escolha o idioma (1-7):'
    lang_saved     = 'Idioma salvo: {0}'
    lang_invalid   = 'Escolha inválida. Digite um número de 1 a 7.'
}
...
$L.de = @{
    ...
    lang_menu2     = '  4 - Español    5 - Português  6 - Deutsch'
    lang_menu3     = '  7 - Français'
    lang_choose    = 'Sprache wählen (1-7):'
    lang_saved     = 'Sprache gespeichert: {0}'
    lang_invalid   = 'Ungültige Auswahl. Gib eine Zahl von 1 bis 7 ein.'
}
...
$L.fr = @{
    ...
    lang_menu2     = '  4 - Español    5 - Português  6 - Deutsch'
    lang_menu3     = '  7 - Français'
    lang_choose    = 'Choisissez la langue (1-7) :'
    lang_saved     = 'Langue enregistrée : {0}'
    lang_invalid   = 'Choix invalide. Entrez un nombre de 1 à 7.'
}
...
$langNames = @{ en = 'English'; ru = 'Русский'; zh = '中文'; es = 'Español'; pt = 'Português'; de = 'Deutsch'; fr = 'Français' }
$langCodes = @('en','ru','zh','es','pt','de','fr')
...
if ($langMode) {
    ...
    $pick = 0
    while ($pick -lt 1 -or $pick -gt 7) {
        $ans = Read-Host $T.lang_choose
        if ($ans -match '^\d+$') { $pick = [int]$ans }
        if ($pick -lt 1 -or $pick -gt 7) { Write-Host $T.lang_invalid -ForegroundColor Red }
    }
...
try {
    ...
    if (-not [Console]::IsOutputRedirected) {
        ...
        try {
            ...
            if ($lang -eq 'zh') { $fi.FaceName = 'SimSun' }
